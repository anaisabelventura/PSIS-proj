...
void write_card(int  board_x, int board_y, char * text, int r, int g, int b){
	...
	rectangle.x = board_x * col_width;
	rectangle.y = board_y * row_height;
	rectangle.w = col_width+1;
	rectangle.h = row_height+1;
	...
	SDL_RenderCopy(renderer, Background_Tx, NULL, &rectangle);
